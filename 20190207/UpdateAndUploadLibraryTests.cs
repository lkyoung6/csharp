...
namespace UpdateAndUploadLibrary.Test
{
    ...
    public class UpdateAndUploadLibraryTests
    {
        ...
        public void ExtractVersionFromFileOnFtp_ReturnsThirdParameter()
        {
            ...
            Mock<FakeWebClient> client = new Mock<FakeWebClient>();
            //WebClient
            //byte[] bytes = null;
            ...
            client.Setup(x => x.DownloadData("ftp://localhost/" + "1.0.0.109.txt")).Returns(bytes);

            DistributionUpdate distributionUpdate = new DistributionUpdate(client.Object);
