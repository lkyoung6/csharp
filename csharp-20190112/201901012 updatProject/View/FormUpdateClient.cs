    ...
    public partial class FormUpdateClient : Form, IFormUpdateClient
    {
        ...
        private void btnUpload_Click(object sender, EventArgs e)
        {
            if (this.CorparationName != null)
            {
                ...
                int isUploadDllFiles = Presenter.UploadDllFilesToFTP(directoryInfo, dllFileVersion);
                ...
                int isUploadVersionTxtFile = Presenter.UploadVersionTxtfileToFTP(this.CorparationName, dllFileVersion);
                ...
                int isUploadCrcTxtFile = Presenter.UploadCRCTxtFileToFTP(SourceFolderPath, dllFileVersion);
